...
def create_side_by_side_comparison(master_frame, captured_frame, diff_percent):
    ...
    target_height = 480 # A reasonable standard height
...
def main(): #
    ...
    parser.add_argument("--threshold", type=float, default=20.0, help="Difference percentage (0-100) to trigger change detection.") #
    ...
    try:
        ...
        while True: #
            ...
            if args.master_frame_mode: #
                ...
                if not args.headless: draw_ui_text(display_frame, "STATUS: Frame-to-Frame Comparison Mode")
